...
$posts = fetch_all_data_usingPDO($pdo,"select * from blog where status = 1 ORDER BY blog_id DESC");
        ...
        <div class="row headstart">
            ...
            <div class="col-md-6">
                <div style="margin-left:60%;">
                    <a href="blog_add.php" class="btn btn-success addfood" style="min-width: 150px;"><i class="fa fa-plus-circle" aria-hidden="true"></i> &nbsp;Add Blog</a>
