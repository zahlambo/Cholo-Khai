...
<?php 
    ...
    $post_list = fetch_all_data_usingPDO($pdo,"select * from post where status = 1  ORDER BY post_id DESC");
              ...
              <tbody>
                ...
                ?>
                    <tr>
                      ...
                      <td>
                        <a href="action.php?post_remove_id=<?= $data['post_id'] ?>" class="btn btn-sm btn-danger">Remove Item</a>
                      </td>
