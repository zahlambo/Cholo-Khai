...
<?php 
    ...
    $blog_list = fetch_all_data_usingPDO($pdo,"select * from blog where status = 0 ORDER BY blog_id DESC");
            ...
            <table id="myTable" class="table display responsive nowrap">
              ...
              <tbody>
                ...
                ?>
                    ...
                    <td>
                        <a href="action.php?blog_approve_id=<?= $data['blog_id'] ?>" class="btn btn-success btn-small">Approve</a>
                        <a href="action.php?blog_delete_id=<?= $data['blog_id'] ?>" class="btn btn-danger btn-small">Delete</a>
                    </td>
